      ...
      <div className='pjt-content'>
        <div className='project'>
          ...
          <span>This website allows you to see your favorite superheroes details such as status,biography,appearance,etc.<br/>
             And the best of it all is compare their power stats.</span>
          <a href='https://bw-dani.github.io/superheroes-database/' target="_blank">
            <img className='pjct-img' src={ P1}/>
          </a>
          <h5> <a href='https://github.com/bw-dani/superheroes-database' target="_blank">  GitHub link</a></h5>
        </div>
        <hr/>
        <div className='project'>
          ...
          Keeping a journal is a good way to track your moods, energy levels, and mental health symptoms.<br/>
            Over time, journaling these things might help you recognize things that trigger depression and anxiety.</span>
          <a href='https://mentalhelp.netlify.app/' target="_blank">
            <img className='pjct-img' src={ P2}/>
          </a>
          <h5> <a href='https://github.com/bw-dani/mental-help' target="_blank">  GitHub link</a></h5>
        </div>
        <hr/>
        <div className='project'>
          ...
          This app was built collaboratively in a team environment of developers and UX designers using Git version control.  </span>
          <a href='https://ballot-request-elections-app.netlify.app' target="_blank">
            <img className='pjct-img' src={ P3}/>
          </a>
          <h5> <a href='https://github.com/bw-dani/election-app' target="_blank">  GitHub link</a></h5>
        </div>
        <hr/>
        <div className='project'>
          ...
          <span>A Productivity app that helps you organize your ideas and tasks, containing a homepage where you can see the summary of all your tasks,<br />
           a to-do page where you can see all off your added tasks and a detail page where you can edit or delete the task.  </span>
          <a href='https://tackle-it.netlify.app/' target="_blank">
            <img className='pjct-img' src={ P4}/>
          </a>
